		...
		<main>
			...
			<form method="post" action="#" id="sample-form">
				<div class="form-group">
					...
					<input type="text" id="txtName" placeholder="Your Name Here." maxlength="50"/>
				</div>
				<div class="form-group">
					<label for="emailEmail">Your Email:</label>
					<input id="emailEmail" type="email" placeholder="Your Email Here." maxlength="100"/>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<div>
						<label for="txtareaComments">Tell Us More About Yourself:</label>
					</div>
					<textarea rows="5" id="txtareaComments" maxlength="500" placeholder="500 Characters Max."></textarea>
				</div>
				<div class="form-group">
					<button type="submit" class="btn">Submit</button>
				</div>
			</form>
			<img src="http://placekitten.com/g/200/300" alt="placekitten"/>
			<img src="http://placekitten.com/g/200/300" alt="placekitten"/>
			<img src="http://placekitten.com/g/200/300" alt="placekitten"/>
			<p>But the probability of making a six is no greater than that of rolling a seven. I recommend you don't fire until you're within 40,000 kilometers. Well, I'll say this for him - he's sure of himself. Ensign Babyface! I'll be sure to note that in my log. Sure. You'd be surprised how far a hug goes with Geordi, or Worf.</p>
